...
if(empty($uname)){
    header ("Location: order_agree.php?error=User Name is required");
    exit();
}
else if(empty($cont)) {
    header ("Location: order_agree.php?error=Contact is required");
    exit();
}else if(empty($email)) {
    header ("Location: order_agree.php?error=Email is required");
    exit();
}else if(empty($address)) {
    header ("Location: order_agree.php?error=Address is required");
    exit();
}else{
    ...
    header ("Location: order_agree.php");
    exit();
}