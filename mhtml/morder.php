        ...
        <?php $images = array(
            ...
            '../images/frag.jpeg'
              ...
              $names = array(
                ...
                'Rántott Csirkemell',
                'Rántott Sajt',
                'Rántott Gomba Fetával töltve',
                'Csirke Falatkák',
                'Cordon Bleu',
                'Rántott Töltött Csirkemell Olasz Módra',
                'Karagyorgye Szelet',
                'Pljeskavica',
                'Töltött Pljeskavica',
                'Csevapok',
                ...
                'Csirkecomb Roston' ,
                'Csirkemell Roston',
                'Csirkemell Filé Roston Sajttal, Gombával és Paprikával',
                'Roston Csirkemell Filé Szalonnába Tekerve',
                'Tortilla',
                'Vegyes Saláta',
                'Sopszka Saláta',
                'Szerb Saláta',
                ...
                'Somlói Galuska',
                'Gesztenye Püré',
                'Palacsinta Eurokrémmel',
                'Palacsinta Eurokrémmel és Darált Keksszel',
                'Palacsinta Lekvárral',
                'Palacsinta Nutellával',
                'Palacsinta Nutellával és Darált Keksszel',
                'Banana Plazma',
                'Raw Narandza- Urma',
                'Rosberitta Nuts',
                'Raw Jagoda',
...
<selection class="food-menu">
        <div class="food-menu-box">
            ...
            <div class="food-menu-desc">
                ...
                <button onclick="redirectToAnotherPage()" class="btn-primary">RENDELJ MOST!</button>
            </div>
        </div>
    <?php } ?>
        </selection>
    ...
    function toggleCheckbox(label) {
      ...
      if (checkbox.checked) {
        ...
        function redirectToAnotherPage() {
            ...
            window.location.href = "morder_agree.php";
        }
